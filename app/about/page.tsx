  ...
  return (
    <main className="bg-[#FFFFFF]">
      ...
      <section className="py-20 sm:py-28 md:py-32 section-padding bg-white">
        <div className="container-width">
          <div className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
            ...
            <div className="rounded-3xl border border-[#ECE8DF] bg-[#FAF8F5] p-8 sm:p-10 shadow-[0_8px_30px_rgba(15,15,15,0.02)]">
      ...
      <section className="py-20 sm:py-28 section-padding bg-[#FAF8F5] border-y border-[#ECE8DF]/40">
        <div className="container-width grid gap-8 sm:grid-cols-2">
          
          {/* Vision */}
          <Card className="rounded-2xl border-[#ECE8DF] p-8 sm:p-12 shadow-[0_8px_24px_rgba(15,15,15,0.02)] bg-white relative overflow-hidden group">
            ...
            {valuePillars.map((pillar: any, index: number) => {
              ...
              return (
                <Card 
                  ...
                  className="rounded-2xl border-[#ECE8DF] bg-[#FAF8F5] p-8 shadow-[0_8px_24px_rgba(15,15,15,0.02)] transition-all duration-300 hover:shadow-[0_12px_32px_rgba(217,169,107,0.06)] hover:-translate-y-1.5 hover:bg-white group"
                >
      ...
      {about?.founderMessage && (
        <section className="py-20 sm:py-28 md:py-32 section-padding bg-[#FAF8F5] border-t border-[#ECE8DF]/40">
          <div className="container-width">
            <div className="max-w-4xl mx-auto rounded-3xl border border-[#ECE8DF] bg-white p-8 sm:p-12 md:p-16 shadow-[0_8px_30px_rgba(15,15,15,0.02)] relative overflow-hidden">
      ...
      {about?.stats && about.stats.length > 0 && (
        <section className="py-16 sm:py-20 bg-white border-t border-[#ECE8DF]/40">
          <div className="container-width">
            <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-3 max-w-4xl mx-auto justify-items-center">
