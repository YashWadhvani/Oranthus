...
export default function Categories({
  ...
  const autoCols = categories ? Math.min(categories.length, 4) : 3;
  const colsToUse = columns || autoCols;
    ...
    <section id="products" style={{ scrollMarginTop: "6rem" }} className="bg-[#FFFFFF] section-padding py-16 sm:py-24 md:py-28 lg:py-32">
      <div className="container-width">
        ...
        >
          ...
          <motion.p variants={itemVariants} className="text-lg leading-relaxed text-[#555555] max-w-2xl font-light mx-auto">{description}</motion.p>
        </motion.div>
